<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPages/WBLTeacherMasterPage.master" AutoEventWireup="true" CodeFile="WBLTeacherEvaluation2.aspx.cs" Inherits="WebPages_Teacher_WebPages_WBLTeacherEvaluation2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
     <table>
            <tr><th>Student Evaluation</th></tr>
        <tr><td>What are the students strength's</td></tr>
        <tr><td>Your Answer</td></tr>
        <tr><td><asp:TextBox ID="txtStrengths" runat="server" name="txtStrengths"></asp:TextBox></td></tr>
        <tr><td>What are the student's areas for growth and improvement?</td></tr>
        <tr><td>Your Answer</td></tr>
        <tr><td><asp:TextBox ID="txtImprovements" runat="server" name="txtImprovements"></asp:TextBox></td></tr>
    ...
    <tr><td>Mixing Score <asp:DropDownList ID="ddMixingScore" runat="server" name="ddMixingScore">
        ...
        <asp:Button ID="Button2" runat="server" Text="Back" OnClick="Back_Click"/><asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="Submit_Click"/>
    </div>
    </form>
</body>
</asp:Content>
