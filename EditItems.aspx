<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditItems.aspx.cs" Inherits="WebPages_Admin_WebPages_EditItems" %>
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <asp:SqlDataSource ID="sqlEditDeleteSubject" runat="server" ConnectionString="<%$ ConnectionStrings:WBLConnectionString %>" DeleteCommand="DELETE FROM [Subject] WHERE [SubjectID] = @SubjectID" InsertCommand="INSERT INTO [Subject] ([SubjectName]) VALUES (@SubjectName)" SelectCommand="SELECT * FROM [Subject] WHERE ([SubjectName] = @SubjectName)" UpdateCommand="UPDATE [Subject] SET [SubjectName] = @SubjectName WHERE [SubjectID] = @SubjectID">
                <DeleteParameters>
