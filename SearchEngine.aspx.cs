...
public partial class WebPages_Admin_WebPages_SearchEngine : System.Web.UI.Page
{
    ...
    protected void btnCategory_Click(object sender, EventArgs e)
        ...
        protected void btnSelectedCategory_Click(object sender, EventArgs e)
        {
            ...
            string[] teacherItems = { "Staff Items","Edit Staff Info", "Classes", "Evaluations" };
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (ddCategory.SelectedIndex == 1)
        {
            ...
            {
                lstStudentSearch.DataSourceID = "sqlSectionSelect";
                ...
                if (IsEmailValid(email) == true)
                {
                    ...
                    else if (ddCategoryItems.SelectedIndex == 2)
                    {
                        ...
                        lblCategoryOption.Text = "Select an Option: ";
                ...
                else
                {
                    ...
                    lblSearchAreaErr.Text = "Please Enter a Valid Email Address.";
    ...
    protected void btnCategoryOptionSelect_Click(object sender, EventArgs e)
    {
        ...
        if (ddCategory.SelectedIndex == 1)
        {
            ...
            if (ddSelectedCategory.SelectedIndex == 2)
            {
                ...
                else if (ddCategoryOptions.SelectedIndex == 0)
                {
                    dropTeacherToClassArea();
                    lblCategoryOptionErr.Visible = false;
                    gvTeacherSchedule.Visible = true;
                }
                else
                {
                    dropTeacherToClassArea();
                    gvTeacherSchedule.Visible = false;
                    lblCategoryOptionErr.Visible = true;
                }
            }
        }
        // Academy
